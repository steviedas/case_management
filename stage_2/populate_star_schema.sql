...
EXEC sp_populate_bridge_case_intervention;  -- Depends on: fact_case, fact_interventions
EXEC sp_populate_bridge_case_alert;         -- Depends on: fact_case, fact_alert
EXEC sp_populate_bridge_case_delphi_unit;   -- Depends on: fact_case, dim_delphi_unit
